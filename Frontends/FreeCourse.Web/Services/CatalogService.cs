...
namespace FreeCourse.Web.Services
{
    public class CatalogService : ICatalogService
    {
        ...
        {
            var resultPhotoService = await _photoStockService.UploadPhoto((Microsoft.AspNetCore.Http.FormFile)courseCreateInput.PhotoFormFile);
        ...
        public async Task<List<CategoryViewModel>> GetAllCategoryAsnyc()
        {
        ...
        public async Task<List<CourseViewModel>> GetAllCourseAsnyc()
        {
        ...
        {
            var resultPhotoService = await _photoStockService.UploadPhoto((Microsoft.AspNetCore.Http.FormFile)courseUpdateInput.PhotoFormFile);
